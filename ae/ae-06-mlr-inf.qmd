...
## Exploratory data analysis - UPDATE
...
Conduct a hypothesis test for the effect of `bill_length_mm`.
...
-   maybe talk about the differences between both permuting the response variable vs a single variable - aybe compare both approaches?
...
null_dist <- _____ |>
  ...
  generate(reps = _____, type = "permute", var) |>
  fit()
```
