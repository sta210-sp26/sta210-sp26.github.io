...
::: callout-important
Go to the [course GitHub organization](https://github.com/sta210-sp26) and locate your `ae-09` repo to get started.
:::
...
Split the data into training (80%) and testing (20%) sets. Use seed `210`.
