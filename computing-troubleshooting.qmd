...
-   If the status shows `Operational`, this means the system is expected to be working. If you’re still having trouble, follow the steps in the order given below[^1]:
...
[^1]: These troubleshooting steps are from [https://sta199-f25.github.io/computing-troubleshooting.html](https://sta199-f25.github.io/computing-troubleshooting)
