...
In this analysis you will use multiple linear regression to describe the relationship between the price and various features of a LEGO sets based on data from brickset.com.
...
You will work with data on about 396 randomly selected LEGO sets produced during this time period. The primary variables are interest in this analysis are
...
b.  Visualize the relationship between `Price` and `minifigures_fct`. Write two observations from the plot.
...
c.  Describe the effect of `Pieces` for LEGOS in the Friends theme in the context of the data.
