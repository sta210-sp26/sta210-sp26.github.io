...
::: callout-tip
See the [Data visualization with ggplot2 cheatsheet](https://rstudio.github.io/cheatsheets/data-visualization.pdf) or the [ggplot2 reference page](https://ggplot2.tidyverse.org/reference/index.html#geoms) for inspiration.
:::
...
Now we will explore the change in ice duration over time.
...
-   Show all relevant code and output used to conduct the test. Use `set.seed(210)` and 1000 iterations to construct the appropriate distribution.
...
b.  Construct a 92% bootstrap confidence interval for the slope using the same seed as before (`210)`. In your response:
...
c.  Interpret the 92% confidence interval for the slope in the context of the data.
