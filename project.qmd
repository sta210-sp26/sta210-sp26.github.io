...
[Prelminary analysis](#prelim-analysis) due April 2
...
Write your draft analysis in the `written-report.qmd` file in your GitHub repo. Push the `.qmd` and rendered `.pdf` documents to GitHub by **April 2 at 11:59pm**.
:::
...
-   **Content:** The student told a unified story that clearly introduced the subject matter, research question, and exploration of the data.
...
-   For each project you're reviewing:
