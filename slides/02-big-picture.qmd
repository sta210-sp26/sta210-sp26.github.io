...
-   Triangle Sports Analytics Competition: <https://triangle-sports.github.io/>
    -   See [Ed Discussion](https://edstem.org/us/courses/91299/discussion/7506518) for full announcement
...
![Source: Introduction to Regression Analysis: A Data Science Approach](images/02/data-science-workflow.png)
...
![](images/02/lego-steps.png){fig-align="center" width="80%"}
...
![](images/02/lego-steps-commit-messages.png){fig-align="center" width="80%"}
...
The data are available in [`life-expectancy-data.csv`](https://intro-regression.github.io/data/life-expectancy-data.csv). There are `r nrow(life_exp)` countries (observations) in the data set.
...
::: appex
📋 [sta210-sp26.github.io/ae/ae-02-life-expectancy](../ae/ae-02-life-expectancy.html)
:::
