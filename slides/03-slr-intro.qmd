...
::: aside
[\
Click here](https://intro-regression.github.io/appendix-linear.html#sec-least-sq-math) for full details on finding $\hat{\beta}_0$ and $\hat{\beta}_1$ in simple linear regression.
:::
