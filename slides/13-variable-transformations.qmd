...
$$\begin{aligned}
\log(\text{health_expend}) = 7.096 &- 0.065  \times \text{income_inequality} \\
&+ 1.117 \times \text{educationHigh}
\end{aligned}$$
...
resid_orig + resid_logy + plot_annotation(title = "Residuals vs. predicted")
```
...
## Rules of log and exponential {background-color="#ccddeb"}
...
:::: question
::: midi
Interpret each of the following in terms of the original units of health expenditure
...
:::: midi
::: question
The coefficient of educationHigh is 1.117. Interpret this value in terms of the original units of healthcare expenditure.
:::

🔗 <https://forms.office.com/r/wax7jftQDg>
::::

## Submit

```{=html}
<center><iframe width="640px" height="480px" src="https://forms.office.com/r/wax7jftQDg?embed=true" frameborder="0" marginwidth="0" marginheight="0" style="border: none; max-width:100%; max-height:100vh" allowfullscreen webkitallowfullscreen mozallowfullscreen msallowfullscreen> </iframe></center>
```
:::::
...
$$
\begin{aligned}
\text{life_exp} = 78.575 &+ 0.001 \times \log(\text{health_expend})\\
& - 0.484 \times \text{income_inequality} \\ 
&+ 0.020 \times \text{educationHigh}
\end{aligned}
$$
...
-   Interpret the effect of a 10% increase in health expenditure in the context of the data.
...
See [Appendix A.9](https://intro-regression.github.io/appendix-linear.html#sec-var-transformations-math) for more mathematical details.

## Recap

-   Introduced log-transformation on the response to address violations in equal variance
-   Introduced log-transformation on the predictor to address non-linearity
