...
::: question
-   How do we write this model in terms of the **odds** of being comfortable with driverless cars?

-   Interpret the coefficient of `Agree` in terms of the **odds** of being comfortable with driverless cars.

-   Describe the interpretation between the coefficients the odds ratio.
:::
